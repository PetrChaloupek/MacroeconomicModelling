...
//---------------------------------------------------------//
estimated_params;
    m,                                        BETA_PDF,              0.80,  0.1;                        // Home Cognative Discounting
    phi_pi,                                   NORMAL_PDF,            1.5,   0.75;                        // Home Inflation Feedback Taylor Rule
    phi_y,                                    NORMAL_PDF,            0.125, 0.195;                        // Home Output Feedback Taylor Rule
    phi_pi_star,                              NORMAL_PDF,            1.5,   0.75;                        // Foreign Inflation Feedback Taylor Rule
    phi_y_star,                               NORMAL_PDF,            0.125, 0.195;                       // Foreign Output Feedback Taylor Rule
    rho_rp,                                   BETA_PDF,              0.70,  0.15;                        // Autocorrelation Risk Premium Shock
    rho_g,                                    BETA_PDF,              0.70,  0.15;                        // Autocorrelation Preference Shock, (IN JP, MEAN IS 0.8 FOR PREF, TECH AND RISK PREMIUM SHOCK)
    rho_g_star,                               BETA_PDF,              0.70,  0.15;                        // F Autocorrelation Preference Shock
    rho_i,                                    BETA_PDF,              0.90,  0.075;                        // Interest rate smoothing parameter
    rho_i_star,                               BETA_PDF,              0.90,  0.075;                        // F Interest rate smoothing parameter
    rho_xi,                                   BETA_PDF,              0.70,  0.15;                        // Autocorrelation Cost-push Shock
    rho_xi_star,                              BETA_PDF,              0.70,  0.15;                        // Autocorrelation Cost-push Shock
    siggma,                                   NORMAL_PDF,            1.0, 0.30;
    theta,                                    BETA_PDF,             0.875,  0.075;                       // Calvo Probability of not changing price 
    varphi,                                   GAMMA_PDF,             3,   0.375;                         // Inverse Frisch Elasticity of Labor Supply, JP(2010) 
    rA,                                       NORMAL_PDF,            0.5,   0.375;                        // Steady State Domestic Real Rate
    piA,                                      NORMAL_PDF,            1,     0.375;                        // Steady State Domestic Inflation
    yA,                                       NORMAL_PDF,            0.5,   0.375;                        // Steady State Domestic Output
    rA_star,                                  NORMAL_PDF,            0.5,   0.375;                        // Steady State Foreign Real Rate
    piA_star,                                 NORMAL_PDF,            1,     0.375;                        // Steady State Foreign Inflation
    yA_star,                                  NORMAL_PDF,            0.50,  0.375;                        // Steady State Foreign Output
    deA,                                      NORMAL_PDF,            0.50,  0.375;                         // Steady State Real Exchange Rate
